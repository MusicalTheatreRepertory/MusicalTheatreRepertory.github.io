    ...
    <div className="about-container">
      ...
      <div className="about-content">
        ...
        <div className="about-text">
          <h3>B.A. Dramatic Arts (Emphasis in Musical Theatre), Minor in Dance, Minor in Real Estate Finance | Class of 2026</h3>
          <div className="icon-links">
  <a href="https://adamhhassan.com" target="_blank" rel="noopener noreferrer">
    <img src={websiteIcon} alt="Website Icon" className="icon" />
  </a>
  <a href="https://linkedin.com/in/adam-hassan-2b1840283" target="_blank" rel="noopener noreferrer">
