    ...
    <div className="about-container">
      ...
      <div className="about-content">
        ...
        <div className="about-text">
          <h3>B.S. Computer Engineering & Computer Science, B.S. Pharmacology & Drug Development | Class of 2026</h3>
          <div className="icon-links">
            <a href="http://alexandrasomodi.com" target="_blank" rel="noopener noreferrer">
                <img src={websiteIcon} alt="Website Icon" className="icon" />
            </a>
            <a href="https://linkedin.com/in/alexandra-somodi" target="_blank" rel="noopener noreferrer">
