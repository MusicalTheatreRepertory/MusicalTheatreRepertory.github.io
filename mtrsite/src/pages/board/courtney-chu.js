    ...
    <div className="about-container">
      ...
      <div className="about-content">
        ...
        <div className="about-text">
          ...
          <p>Courtney Chu has been working with MTR since her first semester at USC in 2023. She is currently a Human Bio major at USC, but hopes to continue to work in the entertainment industry in the future. She is passionate about sound design, sound mixing, and acting. A fun fact about her is that her Corgi recently got a wheelchair and zips around running over people's feet! </p>
        </div>
      </div>
    </div>
    </div>
