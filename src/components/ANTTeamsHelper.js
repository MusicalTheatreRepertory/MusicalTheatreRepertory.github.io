import adam from '../images/shows/ant/adam.jpg'
import charlotte from '../images/shows/ant/charlotte.jpg'
import daniel from '../images/shows/ant/daniel.jpg'
import jenelle from '../images/shows/ant/jenelle.jpg'
import karin from '../images/shows/ant/karin.jpg'
import kelly from '../images/shows/ant/kelly.jpg'
import lydia from '../images/shows/ant/lydia.jpg'
import lucas from '../images/shows/ant/lucas.jpg'
import monty from '../images/shows/ant/monty.png'
import theo from '../images/shows/ant/theo.jpeg'
import violet from '../images/shows/ant/violet.jpg'
import mackenzie from '../images/shows/ant/mackenzie.jpg'
import nathan from '../images/shows/ant/nathan.jpg'

import addison from '../images/shows/ant/addison.jpg'
import julian from '../images/shows/ant/julian.jpg'
import micah from '../images/shows/ant/micah.png'
import brooklyn from '../images/shows/ant/brooklyn.jpg'
import gina from '../images/shows/ant/gina.jpg'
import gray from '../images/shows/ant/gray.jpg'
import juno from '../images/shows/ant/juno.jpg'
import kaitlyn from '../images/shows/ant/kaitlyn.jpg'
import keilah from '../images/shows/ant/keilah.jpg'
import namratha from '../images/shows/ant/namratha.jpg'
import paige from '../images/shows/ant/paige.jpg'
import paigeSpeaker from '../images/shows/ant/paigespeaker.png'
import sara from '../images/shows/ant/sara.jpg'
import alexandra from '../images/shows/ant/alexandra.jpg'
import casey from '../images/shows/ant/casey.png'

import abby from '../images/shows/ant/abby.jpg'
import annabel from '../images/shows/ant/annabel.jpg'
import auburn from '../images/shows/ant/auburn.jpg'
import caroline from '../images/shows/ant/caroline.png'
import courtney from '../images/shows/ant/courtney.jpg'
import kiera from '../images/shows/ant/kiera.jpg'
import sev from '../images/shows/ant/sev.jpg'
import jada from '../images/shows/ant/jada.jpg'
import zoelle from '../images/shows/ant/zoelle.jpg'
import maia from '../images/shows/ant/maia.jpg'
import jacob from '../images/shows/ant/jacobhollens.png'

import huck from '../images/shows/ant/huck.jpg'
import jack from '../images/shows/ant/jack.jpg'
import stella from '../images/shows/ant/stella.jpg'
import telisha from '../images/shows/ant/telisha.jpg'
import chloe from '../images/shows/ant/chloe.jpg'
import nic from '../images/shows/ant/nic.jpg'

import serena from '../images/shows/ant/serena.jpg'
import juan from '../images/shows/ant/juan.jpg'

const cast = [
  {
    role: 'Anya',
    name: 'Mackenzie Jaimes',
    bio: "Mackenzie Jaimes (she/her) is a senior from Portland, Oregon, majoring in Theatre (Acting Emphasis) with minors in Cinematic Arts and Songwriting. She is so excited to be performing in 'Anastasia' and to be working with such a dedicated team. Previous credits at USC include MTR's 'Once on This Island,' and SDA's mainstage productions of 'A Chorus Line,' 'Anna in the Tropics,' and 'They Never Called It Chavez Ravine.' Mackenzie has loved every moment of this experience and is grateful for the opportunity. Enjoy the show!",
    img: mackenzie,
  },
  {
    role: 'Dmitry',
...
const design = [
  {
    ...
    name: 'Kiera Reinhard ',
    bio: "Kiera Reinhard (She/Her) is a Junior BFA Theatrical Design major and Cinematic arts minor. This is Kiera's first time working with MTR. Other shows Kiera have worked on here at USC include 'She Loves Me' in the bing theater, 'Troilus and Cressida', 'Broken Shells', and ' The Laramie Project' . After the show Kiera hopes to go into complete hibernation, only to re-emerge for her 21st birthday. She would love to thank her lovely assistant Maia and TD Abby!",
    img: kiera,
  },
  {
    role: 'Assistant Scenic Designer',
    name: 'Maia Tumbokon',
    bio: 'Maia Tumbokon (she/her) is a Freshman in the BFA Theatrical Design major with an emphasis in Scenic/Lighting Design. This is her first time being part of a show at MTR and she is very excited and grateful for this opportunity. In her spare time, Maia likes to crochet, paint, and sleep. Maia hopes you enjoy the show!',
    img: maia,
  },
  {
    role: 'Lighting Designer ',
    name: 'Jacob Hollens',
    bio: 'Jacob Hollens (He/Him) is a senior lighting and scenic designer at USC, originally from Celebration, FL. Jacob has designed for ISPS since his first year in which he continued to design for ISPS and join the boards of MTR and Brand New Theatre. Previous MTR credits include: Next to Normal and Once on This Island. Check out his work at jacobhollens.com. Special thanks to his family and friends for their support.',
    img: jacob,
  },
  {
    role: 'Assistant Lighting Designer ',
    name: 'Caroline Fedigan ',
    bio: 'Caroline Fedigan (she/her) is a freshman in USC’s music industry major. This is her first show with MTR, but her 8th time being on the lighting team for a musical. Caroline is very grateful to be working on a show she has wanted to work on for forever, and the opportunity to work with a wonderful cast and crew. She has a passion for lighting that she peruses through Trojan Event Services and hopefully more MTR shows in the future. She hopes you enjoy the show!',
    img: caroline,
  },
  {
    role: 'Costume Designer',
    name: 'Jada Leung ',
    bio: "Jada Leung (she/her) is a freshman English major. This is her second show at USC, following MTR's 'Falsettos' because she is an MTR groupie 4 life. She probably shouldn't be in charge of things, including writing this bio, but she hopes you'll enjoy the costumes regardless! Beyond costuming, her hobbies include being super funny and smart. Finally, she would like to use this platform to advocate caring about things---'tis the season of putting in effort and giving your work to the world. Thanks always to the rest of the costume team and this wonderful crew.",
    img: jada,
  },
  {
    role: 'Assistant Costume Designer ',
    name: 'Annabel Roubinowitz ',
    bio: 'Annabel Roubinowitz (she/her) is a Business Administration Major at Marshall school of Business. In her spare time, she enjoys assembling extravagant outfits she’ll never have an occasion to wear and watching bootlegs of off-broadway productions starring Barrett Wilbert Weed. This is her first time being apart of an MTR production and she’s so excited to be on the team. She hopes you enjoy the show!',
    img: annabel,
  },
  {
    role: 'Sound Designer',
    name: 'Courtney Chu',
    bio: 'Courtney Chu is a sophomore majoring in Human Biology. She is so excited to be working on her fourth MTR show! Previous sound design credits include ‘The Wolves’, ‘Moonshine and Canned Pasta’, ‘Gruesome Playground Injuries’, and ‘The Little Mermaid’. She is thrilled to be sound designing for this show and hopes you enjoy!',
    img: courtney,
  },
  {
    role: 'Assistant Sound Designer ',
    name: 'Zoelle Pierce',
    bio: "Zoelle Pierce (she/her) is a Junior in the BFA sound design program at USC. She's been involved in many a show at USC including 'Machinal' and 'Twelve Angry Jurors'. Enjoy the show!",
    img: zoelle,
  },
  {
    role: 'Prop Designer',
    name: 'Sev Krauss-McClurg ',
    bio: 'Sev Krauss-McClurg (he/him) is excited to be joining MTR for the first time on Anastasia. He is a freshman technical direction major. He previously has worked on two other ISPs as props manager. Sev is grateful for the opportunity to work alongside such a great group of people!',
    img: sev,
  },
  {
    role: 'Assistant Props Designer ',
    name: "Auburn D'Artell ",
    bio: "Auburn D'Artell (he/they) is a Sophomore in USC's BA Theatre Design major. This is his sixth time working on a show at USC, following last year's productions of 'As You Like It', 'Machinal', and 'Falsettos.' In his free time, Auburn likes to cosplay and dress up his cat, Miss Blanca. He is so grateful for this opportunity to work with Sev on props and the entire team on this production and he hopes you enjoy Anastasia!",
    img: auburn,
  },
  {
    role: 'Technical Director',
    name: 'Abigail Soroka',
    bio: "Abigail Soroka (she/her) is a Sophomore BFA Technical Direction major. Other productions at USC include: 'Angels in America Part 1: Millennium Approaches,' 'As You Like It,' 'Rent,' and 'Dance Nation.' She has also worked as a Stage Manager, Scenic Designer, and bookseller. Abby is a figure skater and likes to bake and read. She hopes you enjoy the show!",
    img: abby,
  },
]
...
const pit = [
  ...
  },
  {
    ...
    bio: 'Stella is a Senior at USC studying architecture with a minor in cinematic arts! This is her first time being part of the pit with MTR! In her spare time she loves to draw, spend time with friends, and travel! Stella is excited to be a part of Anastasia and hopes you all enjoy!',
    img: stella,
  },
  {
    role: 'Violin 2',
    name: 'Chloe Bay ',
    bio: 'Chloe Bay is a freshman at USC pursuing at BA in Theater (Acting) with a minor in Spanish. This is her first time playing pit orchestra, and she’s super excited! She has been playing violin since she was 7, and was a member of i Solisti orchestra for 5 years. On campus, she is a member of The Merry Men improv troupe, the Co-Social Chair for Aeneid Theater Company, and the Assistant Social Chair for Impulse Theater Company. Past roles include Rhesus (ATC, Chorus C/Athena), The Mousetrap (Molly), Trevor (Ashley), A Midsummer Nights Dream (Helena), The Witch of Edmonton (Winifred), and more.',
    img: chloe,
  },
  {
    role: 'Cello',
    name: 'Nicolas Lam',
    bio: "Nicolas 'Nick' Lam (he/him) is a Sophomore in USC's Biopharmaceutical Sciences major. This is his first time being a part of the pit on a show at USC with previous experience in productions of 'Frozen' and orchestral work. In his free time, Nick enjoys snowboarding, napping, and trying to befriend the cats on his street 😸 He is enthusiastic to be a part in another production and is looking forward to many more!",
    img: nic,
  },
  {
    role: 'Bass',
    name: 'Huckleberry Young',
    bio: "Huckleberry 'Huck' Young (he/him) is a Freshman Jazz major deeply interested in musical theater. This is Huck's debut performance with MTR. In his free time Huck loves to jam with his roommates and watch movies. Huckleberry hopes you love the music and are ready to enjoy the show!!",
    img: huck,
  },
  {
    role: 'Euphonium',
    name: 'Telisha Ransome',
    bio: "Telisha Ransome (she/her) is a Sophomore in USC’s Accounting major! She has been playing brass for 9 years and is happy to be back in the pit! She has been a part of previous pits before, including 'Shrek: The Musical' and Beauty and the Beast'! This is her first time in an MTR production and can’t be more excited! In her free time, Telisha reads, goes to the gym, and skydives regularly.",
    img: telisha,
  },
]
...
const crew = [
  {
    role: 'Board Operator',
    name: 'Serena Feng',
    bio: 'Serena Feng (she/her) is a Freshman BFA Stage Management major with a minor in Spanish. At USC, she has worked on Marat/Sade, Polaroid Stories, Troilus and Cressida, and in a few weeks, Bat Boy: the Musical! She is super excited to be a part of her first MTR production and learn a bit more about the world of lighting. Enjoy the show!',
    img: serena,
  },
  {
    role: 'Deck Crew',
    name: 'Juan Moreno Coronado',
    bio: 'Juan Moreno Coronado (he/him) is a freshman at USC studying Electrical and Computer Engineering, with a minor in Theatre. This is his first time being part of the crew on a show at USC, and he is very excited about getting in touch again with the Theatre. He is excited about being part of this production and hopes you enjoy it as much as he does.',
    img: juan,
  },
]

export { cast, creative, design, pit, crew }
