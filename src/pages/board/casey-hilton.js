...
import profilePic from '../../images/people/casey.png' // Replace with your image
  ...
  return (
    <div className="frame">
      ...
      <div className="about-container">
        <h1 className="about-title">Casey Hilton</h1>

        <div className="about-content">
          <div className="about-image">
            <img src={profilePic} alt="Casey Hilton Headshot" />
          </div>

          <div className="about-text">
            <h3>B.A. Theatre | Class of 2028</h3>
          </div>
        </div>
      </div>
    </div>
