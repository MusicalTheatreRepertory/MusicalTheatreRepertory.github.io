...
import profilePic from '../../images/people/mia.png' // Replace with your image
  ...
  return (
    <div className="frame">
      ...
      <div className="about-container">
        <h1 className="about-title">Mia Murillo</h1>

        <div className="about-content">
          <div className="about-image">
            <img src={profilePic} alt="Mia Murillo Headshot" />
          </div>

          <div className="about-text">
            <h3>
              BFA Theatrical Design, Minor in Cinematic Arts | Class of 2027
            </h3>
          </div>
        </div>
      </div>
